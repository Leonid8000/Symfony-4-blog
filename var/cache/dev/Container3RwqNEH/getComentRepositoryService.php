...
// Returns the private 'App\Repository\ComentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComentRepository.php';

return $this->privates['App\\Repository\\ComentRepository'] = new \App\Repository\ComentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
